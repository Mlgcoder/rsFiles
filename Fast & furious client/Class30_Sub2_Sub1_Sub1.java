...
public final class Class30_Sub2_Sub1_Sub1 extends Class30_Sub2_Sub1
{
    ...
    public Class30_Sub2_Sub1_Sub1(byte abyte0[], Component component)
    {
        ...
        try
        {
            Image image = Toolkit.getDefaultToolkit().createImage("./guthixscape.png");
    ...
    public Class30_Sub2_Sub1_Sub1(Class44 class44, String s, int i)
    {
        ...
        if(s.startsWith("back"))
            try
            {
                Image image = Toolkit.getDefaultToolkit().getImage((new StringBuilder()).append("./Sprites/").append(s).append(" ").append(i).append(".jag").toString());
                anIntArray1439 = new int[anInt1440 * anInt1441];
                PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
                pixelgrabber.grabPixels();
                System.out.println((new StringBuilder()).append("Sprite: ").append(s).append(" ").append(i).append(" loaded.").toString());
            }
            catch(Exception exception)
            {
        ...
        if(s.equalsIgnoreCase("headicons_prayer") && i == 6)
            try
            {
                Image image1 = Toolkit.getDefaultToolkit().createImage("./headicons_prayer.png");
                anIntArray1439 = new int[anInt1440 * anInt1441];
                PixelGrabber pixelgrabber1 = new PixelGrabber(image1, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
                pixelgrabber1.grabPixels();
                System.out.println((new StringBuilder()).append(s).append(" ").append(i).append(".png").append(" Loaded").toString());
            }
        ...
        if(s.startsWith("mapback"))
            try
            {
                Image image2 = Toolkit.getDefaultToolkit().getImage((new StringBuilder()).append("./Sprites/").append(s).append(" ").append(i).append(".jag").toString());
                anIntArray1439 = new int[anInt1440 * anInt1441];
        ...
        if(s.startsWith("sideicon"))
            try
            {
                Image image3 = Toolkit.getDefaultToolkit().getImage((new StringBuilder()).append("./Sprites/").append(s).append(" ").append(i).append(".jag").toString());
                anInt1440 = 28;
                anInt1441 = 28;
                anIntArray1439 = new int[anInt1440 * anInt1441];
        ...
        if(s.startsWith("staticons"))
            try
            {
                Image image4 = Toolkit.getDefaultToolkit().getImage((new StringBuilder()).append("./Sprites/").append(s).append(" ").append(i).append(".jag").toString());
                anInt1440 = 28;
                anInt1441 = 28;
                anIntArray1439 = new int[anInt1440 * anInt1441];
                PixelGrabber pixelgrabber4 = new PixelGrabber(image4, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
        ...
        if(s.startsWith("chat"))
            try
            {
                Image image5 = Toolkit.getDefaultToolkit().getImage("./Sprites/CHATBACK 0.jag");
                anIntArray1439 = new int[anInt1440 * anInt1441];
        ...
        if(s.startsWith("redstone2"))
            try
            {
                Image image6 = Toolkit.getDefaultToolkit().getImage("./Sprites/REDSTONE2 0.jag");
                anInt1440 = 33;
                anInt1441 = 37;
                anIntArray1439 = new int[anInt1440 * anInt1441];
                PixelGrabber pixelgrabber6 = new PixelGrabber(image6, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
        ...
        if(s.startsWith("redstone1"))
            try
            {
                ...
                anInt1441 = 37;
                anIntArray1439 = new int[anInt1440 * anInt1441];
                Image image7 = Toolkit.getDefaultToolkit().getImage("./Sprites/REDSTONE1 0.jag");
                if(client.flip)
                    image7 = Toolkit.getDefaultToolkit().getImage("./Sprites/REDSTONE1 1.jag");
                if(client.flip_s)
                    image7 = Toolkit.getDefaultToolkit().getImage("./Sprites/REDSTONE1 2.jag");
                if(client.flip_r)
                    image7 = Toolkit.getDefaultToolkit().getImage("./Sprites/REDSTONE1 3.jag");
        ...
        if(s.startsWith("scroll"))
            try
            {
                Image image8 = Toolkit.getDefaultToolkit().getImage((new StringBuilder()).append("./Sprites/").append(s).append(" ").append(i).append(".jag").toString());
                anIntArray1439 = new int[anInt1440 * anInt1441];
        ...
        if(s.equalsIgnoreCase("invback"))
            try
            {
                Image image9 = Toolkit.getDefaultToolkit().getImage((new StringBuilder()).append("./Sprites/").append(s).append(" ").append(i).append(".jag").toString());
                anIntArray1439 = new int[anInt1440 * anInt1441];
        ...
        if(s.equalsIgnoreCase("compass"))
        {
            try
            {
                Image image10 = Toolkit.getDefaultToolkit().getImage("./Sprites/COMPASS 0.jag");
                anIntArray1439 = new int[anInt1440 * anInt1441];
                PixelGrabber pixelgrabber10 = new PixelGrabber(image10, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
