...
public static int portal4 = 0;
	public static int cWarsWaitTimer = 50;
	public static int updateTeller = 200;
		public static int cWarsGame = 0;
...
if(pcWaitTimer > 0){
			...
			if(updateTeller == 1){
            misc.println("There are currently " + PlayerHandler.getPlayerCount() + " players!");
			}
			if(updateTeller == 0){
			updateTeller = 300;
			}
