...
public class Wearing {
	...
	public int GetCLAttack(int ItemID) {
		...
		if (ItemName2.startsWith("claws")
		 ...
		 || ItemName2.startsWith("halberd")) {
			...
			return 75;
		} else if (ItemName.startsWith("Barek")) {
			return 75;
		...
		if (ItemName2.startsWith("claws")
		 ...
		 || ItemName2.startsWith("halberd")) {
			...
			if (ItemName.startsWith("Bronze")) {
				...
				return 70;
			} else if (ItemName.startsWith("Armadyl chesteplate")) {
				return 70;
	...
	public int GetCLConstruction(int ItemID) {
		...
		String ItemName = GetItemName(ItemID);
		if (ItemName.startsWith("Construction Cape")) {
			return 99;
		}
		if (ItemName.startsWith("Construction hood")) {
			return 99;
		}
		return 1;
	}
