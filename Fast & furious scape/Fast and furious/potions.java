	...
	public void buryItem(int item, int slot, int ID) {
		...
		if (c.playerHasItem(item)) {
			...
			case 4155:
				...
				break;
			case 739:
				c.sM("I wouldn't want to drink this!");
				break;
			case 4049:
			...
			case 464:
				...
				c.setAnimation(0x33D);
				//c.playSound(317, 000, 020);
				c.sM("You eat the strange fruit !.");
				if(c.currentHealth < c.playerLevel[c.playerHitpoints]){
				c.sM("It heals some health.");
				}
				c.deleteItem(464, slot, 1);
			...
			case 2034:
				...
				c.setAnimation(0x33D);
				//c.playSound(317, 000, 020);
				c.sM("You drink the fruit blast !.");
				if(c.currentHealth < c.playerLevel[c.playerHitpoints]){
				c.sM("It heals some health.");
				}
				c.deleteItem(2034, slot, 1);
			...
			case 4053: //Barricade
		c.setAnimation(827);
		c.deleteItem(4053, c.getItemSlot(4053), 1);
		c.makeGlobalObject(c.absX, c.absY, 4421, 0, 10);
break;
case 6800:
c.championscroll();
break;
