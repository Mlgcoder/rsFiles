...
public static int beta = 0;
			public static int playersInAlpha = 0;
			public static int playersInBeta = 0;
...
public boolean Redemption;
	public String clanName = "none", clanLeader = "nobody", clanColor = "white";
	public String[] clanMembers = new String[17]; //17 total
	public int[] CCID = { 7332, 7333, 7334, 7336, 7383, 7339, 7338, 7340, 7346, 7341, 7342, 7337, 7343, 7335, 7344, 7345, 7347, 7348 };
